     ...
     <div class="link" style=" border-right:  #CCC 1px solid;"> 
      ...
      <i class="fa fa-chevron-down"></i> 
	     ...
	     <ul class="submenu"> 
	      ...
	      <li><a href="/Config/findLogistics" data-toggle="modal" data-target="#myModal">仓库新增</a></li>
	      <li><a href="/Config/modifyLogistics">仓库修改</a></li>
	      <li><a href="/Config/sortLogistics">仓库分类</a></li>
	      <li><a href="#">仓库删除</a></li>
	     </ul> 
     </li> 
</nav>
  ...
  <div class="modal-dialog">  
    <div class="modal-content">  
      <div class="modal-header">       
        <h3 class="modal-title">仓库新增</h3>  
         <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>  
      </div>  
      <div class="modal-body">  
        <input class="form-control"  placeholder="请输入仓库名称"/><br/>
		<input class="form-control" placeholder="输入仓库序号(序号越大越靠前)"/>
