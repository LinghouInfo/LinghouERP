        ...
        <div role="tabpanel" class="tab-pane active" id="home"> 
         ...
         <form class="form-inline"> 
          <div class="form-group"> 
           ...
           <input placeholder="请输入搜索的品牌名称" onpaste="return false" oncontextmenu="return false" name="brandName" class="form-control" /> 
          </div> 
          <button class="btn btn-primary icon-search">搜索</button> 
         </form> 
         <button class="btn btn-primary icon-search" data-toggle="modal" style="position:relative; top:-31px;  left:250px;" data-target="#exampleModal" data-whatever="@fat">新建品牌</button> 
          ...
          <table class="table"> 
           ...
           <tbody> 
            <tr> 
             <td>#99</td> 
             <td>Bangalore</td> 
             <td> <select id="pid" class="form-control" onchange="operationChange()"> <option selected="selected">选择操作</option> <option operation="delete" value="1">删除品牌信息</option> <option operation="update" value="2">修改该品牌信息</option> </select> </td> 
            </tr> 
            <tr> 
             <td>#98</td> 
             <td>Mumbai</td> 
             <td> <select class="form-control" onchange="operationChange()"> <option selected="selected">选择操作</option> <option operation="delete" value="1">删除该品牌信息</option> <option operation="update" value="2">修改该品牌信息</option> </select> </td> 
            </tr> 
           </tbody> 
          </table> 
         </div> 
	           ...
	           switch(operation)
	           {
	               ...
	               case "update":
	            	  alert(objS.options[objS.selectedIndex].getAttribute('value'));	            	   
	            	   $("#exampleModal2").modal(); 
	            	   $("#brandId").attr("value",objS.options[objS.selectedIndex].getAttribute('value'));
	                      break;
	               default:;
	           } 
	       }          
