     ...
     <div class="link" style=" border-right:  #CCC 1px solid;"> 
      ...
      <i class="fa fa-chevron-down"></i> 
	     ...
	     <ul class="submenu"> 
	      ...
	      <li><a href="/Config/findSpu" data-toggle="modal" data-target="#myModal">新增SPU</a></li>
	      
	      <li><a href="/Config/sortSpu">SPU分类</a></li>
	      <li><a href="/Config/spuModify">SPU修改</a></li>
	      <li><a href="#">删除SUP</a></li>
	     </ul> 
     </li> 
</nav>
<style type="text/css">	
  ...
  <div class="modal-dialog">  
    <div class="modal-content">  
      ...
      <div class="modal-body">  
        <input class="form-control"  placeholder="请输入SPU名称"/><br/>
